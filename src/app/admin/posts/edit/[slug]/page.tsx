...
export default function EditPost() {
  ...
  return (
    <AdminLayout>
      ...
      {success && (
        <div className="mb-6 bg-brand-light border border-brand-accent text-brand-deep px-4 py-3 rounded">
          {success}
        </div>
      )}
      ...
      <AdminCard title="Thông tin bài viết">
        <form onSubmit={handleSubmit}>
          ...
          {formData.category === 'proposal' && (
            <div className="mb-6 bg-brand-light border-l-4 border-brand-accent p-4 rounded">
